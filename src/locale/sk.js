export default {
    ...
    toolbar: {
        undo: "Späť",
        redo: "Znovu",
        paintFormat: "Formátovanie štetcom",
        currencyFormat: "Formátovať ako menu",
        percentageFormat: "Formátovať ako percento",
        numberDecrease: "Znížiť desatinné miesta",
        numberIncrease: "Zvýšiť desatinné miesta",
        moreFormats: "Viac formátov",
        font: "Písmo",
        fontSize: "Veľkosť písma",
        bold: "Tučné (Ctrl+B)",
        italic: "Kurzíva (Ctrl+I)",
        strikethrough: "Prečiarknuté (Alt+Shift+5)",
        underline: "Podčiarknuté",
        textColor: "Farba textu",
        chooseColor: "Vyberte farbu",
        resetColor: "Resetovať",
        customColor: "Vlastná",
        alternatingColors: "Striedavé farby",
        confirmColor: "OK",
        cancelColor: "Zrušiť",
        collapse: "Zbaliť",
        ...
        mergeCell: "Zlúčiť bunky",
        chooseMergeType: "Vybrať typ zlúčenia",
        horizontalAlign: "Horizontálne zarovnanie",
        verticalAlign: "Vertikálne zarovnanie",
        alignment: "Zarovnanie",
        textWrap: "Zalomenie textu",
        textWrapMode: "Režim zalomenia textu",
        textRotate: "Otočenie textu",
        textRotateMode: "Režim otočenia textu",
        freezeTopRow: "Zmraziť prvý riadok",
        sortAndFilter: "Triediť a filtrovať",
        findAndReplace: "Nájsť a nahradiť",
        sum: "SÚČET",
        autoSum: "Automatický SÚČET",
        moreFunction: "Viac funkcií",
        conditionalFormat: "Podmienené formátovanie",
        postil: "Komentár",
        pivotTable: "Kontingenčná tabuľka",
        chart: "Graf",
        screenshot: "Snímka obrazovky",
        splitColumn: "Rozdeliť text",
        insertImage: "Vložiť obrázok",
        insertLink: "Vložiť odkaz",
        dataVerification: "Overenie údajov",
        protection: "Chrániť hárok",

        clearText: "Vymazať farbu",
        noColorSelectedText: "Nie je vybratá žiadna farba",

        toolMore: "Viac",
        toolLess: "Menej",
        toolClose: "Zatvoriť",
        toolMoreTip: "Viac funkcií",
        moreOptions: "Viac možností",

        cellFormat: "Konfigurácia formátu bunky",
        print: "Tlačiť"
    },
    alternatingColors:{
    ...
    filter:{
        filter: "Vytvoriť filter",

        sortByAsc: "Zoradiť A-Z",
        sortByDesc: "Zoradiť Z-A",
        
        filterByColor: "Filtrovať podľa farby",
        filterByCondition: "Filtrovať podľa podmienky",
        filterByValues: "Filtrovať podľa hodnôt",
        
        filiterInputNone: "Žiadne",
        
        filiterInputTip: "Zadajte hodnotu filtra",
        filiterRangeStart: "",
        filiterRangeStartTip: "Hodnota pre vzorec",
        filiterRangeEnd: "a",
        filiterRangeEndTip: "Hodnota pre vzorec",
        
        filterValueByAllBtn: "Vybrať všetky",
        filterValueByClearBtn: "Vymazať",
        filterValueByInverseBtn: "Invertovať",
        filterValueByTip: "Filtrovať podľa hodnôt",
        
        filterConform: "Potvrdiť",
        filterCancel: "Zrušiť",
        clearFilter: "Vymazať filter",
        
        conditionNone: "Žiadne",
        
        conditionCellIsNull: "Je prázdny",
        conditionCellNotNull: "Nie je prázdny",
        conditionCellTextContain: "Text obsahuje",
        conditionCellTextNotContain: "Text neobsahuje",
        conditionCellTextStart: "Text začína na",
        conditionCellTextEnd: "Text končí na",
        conditionCellTextEqual: "Text je presne",
        conditionCellDateEqual: "Dátum je",
        conditionCellDateBefore: "Dátum je pred",
        conditionCellDateAfter: "Dátum je po",
        conditionCellGreater: "Väčší ako",
        conditionCellGreaterEqual: "Väčší alebo rovný",
        conditionCellLess: "Menší ako",
        conditionCellLessEqual: "Menší alebo rovný",
        conditionCellEqual: "Je rovný",
        conditionCellNotEqual: "Nie je rovný",
        conditionCellBetween: "Je medzi",
        conditionCellNotBetween: "Nie je medzi",
        
        filiterMoreDataTip: "Veľké množstvo dát! Prosím čakajte",
        filiterMonthText: "Mesiac",
        filiterYearText: "Rok",
        filiterByColorTip: "Filtrovať podľa farby bunky",
        filiterByTextColorTip: "Filtrovať podľa farby písma",
        filterContainerOneColorTip: "Tento stĺpec obsahuje iba jednu farbu",
        filterDateFormatTip: "Formát dátumu",
        
        valueBlank: "(Prázdne)",
        mergeError: "Vo výbere filtra sú zlúčené bunky, túto operáciu nie je možné vykonať!"
    },
    rightclick: {
        copy: "Kopírovať",
        copyAs: "Kopírovať ako",
        paste: "Vložiť",
        insert: "Vložiť",
        delete: "Vymazať",
        deleteCell: "Vymazať bunku",
        ...
        matrix: "Matica",
        sortSelection: "Triediť",
        filterSelection: "Filtrovať",
        chartGeneration: "Vytvoriť graf",
        firstLineTitle: "Prvý riadok názvu",
        untitled: "Bez názvu",
        array1: "Jednorozmerné pole",
        array2: "Dvojrozmerné pole",
        array3: "Viacrozmerné pole",
        diagonal: "Diagonála",
        antiDiagonal: "Antidiagonála",
        diagonalOffset: "Diagonálny posun",
        offset: "Posun",
        boolean: "Boolean",
        flip: "Otočiť",
        upAndDown: "Hore a dole",
        leftAndRight: "Vľavo a vpravo",
        ...
        root: "Koreň",
        log: "Logaritmus",
        delete0: "Vymazať hodnoty 0 na oboch koncoch",
        removeDuplicate: "Odstrániť duplicitné hodnoty",
        byRow: "Podľa riadku",
        byCol: "Podľa stĺpca",
        generateNewMatrix: "Generovať novú maticu"
    },
    comment:{
        "insert":"Insert",
        "edit":"Edit",
    ...
    findAndReplace:{
        ...
        columnSpan: "Rozsah stĺpcov",
        locationExample: "Príklad lokácie",
        lessTwoRowTip: "Vyberte prosím aspoň dva riadky",
        lessTwoColumnTip: "Vyberte prosím aspoň dva stĺpce",

        findTextbox: "Nájsť obsah",
        replaceTextbox: "Nahradiť obsah",

        regexTextbox: "Regulárny výraz",
        wholeTextbox: "Celé slovo",
        distinguishTextbox: "Rozlišovať veľkosť písmen",

        allReplaceBtn: "Nahradiť všetko",
        replaceBtn: "Nahradiť",
        allFindBtn: "Nájsť všetko",
        findBtn: "Nájsť ďalší",

        noFindTip: "Obsah nebol nájdený",
        modeTip: "Táto operácia nie je k dispozícii v tomto režime",

        searchTargetSheet: "Hárka",
        searchTargetCell: "Bunka",
        searchTargetValue: "Hodnota",

        searchInputTip: "Prosím, zadajte hľadaný obsah",

        noReplceTip: "Nie je čo nahradiť",
        noMatchTip: "Nenašli sa žiadne zhody",

        successTip: "Nájdených ${xlength} položiek",

        locationConstant: "Konštanta",
        locationFormula: "Vzorec",
        locationDate: "Dátum",
        locationDigital: "Číslo",
        locationString: "Reťazec",
        locationBool: "Logická hodnota",
        locationError: "Chyba",
        locationNull: "Nulová hodnota",
        locationCondition: "Podmienené formátovanie",
        locationRowSpan: "Rozsah riadkov",
        locationColumnSpan: "Rozsah stĺpcov",

        locationTiplessTwoRow: "Vyberte prosím aspoň dva riadky",
        locationTiplessTwoColumn: "Vyberte prosím aspoň dva stĺpce",
        locationTipNotFindCell: "Bunka nebola nájdená"
    },
    sheetconfig: {
        delete: "Vymazať",
        copy: "Kopírovať",
        ...
        resetColor: "Resetovať farbu",
        cancelText: "Zrušiť",
        chooseText: "Potvrdiť farbu",

        tipNameRepeat: "Názov karty stránky sa nesmie opakovať! Prosím opravte",
        noMoreSheet: "Zošit obsahuje aspoň jeden viditeľný hárok. Ak chcete vymazať vybraný hárok, vložte nový hárok alebo zobrazte skrytý hárok.",
        confirmDelete: "Ste si istí, že chcete vymazať",
        redoDelete: "Môže byť vrátené späť pomocou Ctrl+Z",
        noHide: "Nie je možné skryť, aspoň jedna karta hárku musí zostať",
        chartEditNoOpt: "Táto operácia nie je povolená v režime úpravy grafu!",
        sheetNameSpecCharError: "Názov nesmie obsahovať: [ ] : \\ ? * / ' \"",
        sheetNamecannotIsEmptyError: "Názov hárku nemôže byť prázdny"
    },
    conditionformat: {
    ...
    formula:{
        ...
        max: "Maximum",
        min: "Minimum",
        ifGenerate: "Generátor IF vzorca",
        find: "Zistiť viac",

        tipNotBelongToIf: "Táto bunková funkcia nepatrí do IF vzorca!",
        tipSelectCell: "Prosím, vyberte bunku na vloženie funkcie",

        ifGenCompareValueTitle: "Porovnávacia hodnota",
        ifGenSelectCellTitle: "Kliknite pre výber bunky",
        ifGenRangeTitle: "Rozsah",
        ifGenRangeTo: "do",
        ifGenRangeEvaluate: "Hodnotenie rozsahu",
        ifGenSelectRangeTitle: "Kliknite pre výber rozsahu",
        ifGenCutWay: "Spôsob rozdelenia",
        ifGenCutSame: "Rozdelenie podľa rovnakej hodnoty",
        ifGenCutNpiece: "Rozdelenie podľa N",
        ifGenCutCustom: "Vlastné",
        ifGenCutConfirm: "Potvrdiť",

        ifGenTipSelectCell: "Vyberte bunky",
        ifGenTipSelectCellPlace: "Prosím, vyberte bunky",

        ifGenTipSelectRange: "Vyberte rozsah",
        ifGenTipSelectRangePlace: "Prosím, vyberte rozsah",

        ifGenTipNotNullValue: "Porovnávacia hodnota nesmie byť prázdna!",
        ifGenTipLableTitile: "Označenie",
        ifGenTipRangeNotforNull: "Rozsah nesmie byť prázdny!",
        ifGenTipCutValueNotforNull: "Hodnota rozdelenia nesmie byť prázdna!",
        ifGenTipNotGenCondition: "Pre generovanie nie sú k dispozícii žiadne podmienky!"
    },
    formulaMore:{
        valueTitle:"Value",
    ...
    protection:{
        ...
        enterPassword: "Zadajte heslo (voliteľné)",
        enterHintTitle: "Výzva pri úprave je zakázaná (voliteľné)",
        enterHint: "Bunka alebo graf, ktorý sa pokúšate zmeniť, je v chránenom hárku. Ak ho chcete zmeniť, odomknite hárok. Možno budete musieť zadať heslo",
        swichProtectionTip: "Chrániť hárok a obsah uzamknutých buniek",
        authorityTitle: "Povoliť používateľom tohto hárka:",
        selectLockedCells: "Vyberať uzamknuté bunky",
        selectunLockedCells: "Vyberať odomknuté bunky",
        formatCells: "Formátovať bunky",
        formatColumns: "Formátovať stĺpce",
        formatRows: "Formátovať riadky",
        insertColumns: "Vkladať stĺpce",
        insertRows: "Vkladať riadky",
        insertHyperlinks: "Vkladať hypertextové odkazy",
        deleteColumns: "Mažú stĺpce",
        deleteRows: "Mažú riadky",
        sort: "Triediť",
        filter: "Filtrovať",
        usePivotTablereports: "Používať kontingenčné tabuľky",
        editObjects: "Upravovať objekty",
        editScenarios: "Upravovať scenáre",

        allowRangeTitle: "Povoliť používateľom rozsahu:",
        allowRangeAdd: "Nový...",

        allowRangeAddTitle: "Názov",
        allowRangeAddSqrf: "Referencie",
        selectCellRange: "Kliknite pre výber rozsahu buniek",
        selectCellRangeHolder: "Rozsah buniek",
        allowRangeAddTitlePassword: "Heslo",
        allowRangeAddTitleHint: "Výzva",
        allowRangeAddTitleHintTitle: "Výzva pri nastavení hesla (voliteľné)",
        allowRangeAddtitleDefault: "Zadajte názov rozsahu",

        rangeItemDblclick: "Dvojklik pre úpravu",
        rangeItemHasPassword: "Má heslo",

        rangeItemErrorTitleNull: "Názov je prázdny",
        rangeItemErrorRangeNull: "Referencie sú prázdne",
        rangeItemErrorRange: "Chybná referencia",

        validationTitle: "Overenie hesla",
        validationTips: "Na odomknutie ochrany hárku je potrebné zadať heslo",
        validationInputHint: "Zadajte heslo",

        checkPasswordNullalert: "Heslo je povinné!",
        checkPasswordWrongalert: "Nesprávne heslo, skúste to znova!",

        checkPasswordSucceedalert: "Úspešne odomknuté!",
        defaultRangeHintText: "Bunka je chránená heslom.",
        defaultSheetHintText: "Bunka alebo graf je v chránenom hárku. Ak chcete vykonať zmeny, odomknite hárok. Možno budete musieť zadať heslo"
    },
    cellFormat:{
