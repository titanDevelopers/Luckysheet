export default {
    ...
    toolbar: {
        undo: "Zpět",
        redo: "Znovu",
        paintFormat: "Formátování štětcem",
        currencyFormat: "Formátovat jako měnu",
        percentageFormat: "Formátovat jako procento",
        numberDecrease: "Snížit desetinná místa",
        numberIncrease: "Zvýšit desetinná místa",
        moreFormats: "Více formátů",
        font: "Písmo",
        fontSize: "Velikost písma",
        bold: "Tučné (Ctrl+B)",
        italic: "Kurzíva (Ctrl+I)",
        strikethrough: "Přeškrtnuté (Alt+Shift+5)",
        underline: "Podtržené",
        textColor: "Barva textu",
        chooseColor: "Vyberte barvu",
        resetColor: "Resetovat",
        customColor: "Vlastní",
        alternatingColors: "Střídavé barvy",
        confirmColor: "OK",
        cancelColor: "Zrušit",
        collapse: "Sbalit",
        ...
        chooseMergeType: "Vybrat typ sloučení",
        horizontalAlign: "Horizontální zarovnání",
        verticalAlign: "Vertikální zarovnání",
        alignment: "Zarovnání",
        textWrap: "Zalomit text",
        textWrapMode: "Režim zalomení textu",
        textRotate: "Otočení textu",
        textRotateMode: "Režim otočení textu",
        freezeTopRow: "Zmrazit první řádek",
        sortAndFilter: "Třídit a filtrovat",
        findAndReplace: "Najít a nahradit",
        sum: "SOUČET",
        autoSum: "Automatický SOUČET",
        moreFunction: "Více funkcí",
        conditionalFormat: "Podmíněné formátování",
        postil: "Komentář",
        pivotTable: "Kontingenční tabulka",
        chart: "Graf",
        screenshot: "Snímek obrazovky",
        splitColumn: "Rozdělit text",
        insertImage: "Vložit obrázek",
        insertLink: "Vložit odkaz",
        dataVerification: "Ověření údajů",
        protection: "Chránit list",
    
        clearText: "Vymazat barvu",
        noColorSelectedText: "Není vybrána žádná barva",
    
        toolMore: "Více",
        toolLess: "Méně",
        toolClose: "Zavřít",
        toolMoreTip: "Více funkcí",
        moreOptions: "Více možností",
    
        cellFormat: "Konfigurace formátu buňky",
        print: "Tisk"
    },
    alternatingColors:{
    ...
    info:{
        detailUpdate: "Nové otvorené",
        detailSave: "Lokálna vyrovnávacia pamäť obnovená",
        row: "Riadok",
        column: "Stĺpec",
        loading: "Načítava sa...",
        ...
        return: "Opustiť",
        rename: "Premenovať",
        tips: "Premenovať zošit",
        noName: "Nepomenovaný hárček",
        wait: "Čaká sa na aktualizáciu",

        add: "Pridať",
        addLast: "viac riadkov dole",
        backTop: "Späť na začiatok",
        pageInfo: "Celkom ${total}，${totalPage} stránka，aktuálna ${currentPage}",
        nextPage: "Ďalšia",

        tipInputNumber: "Prosím, zadajte číslo",
        tipInputNumberLimit: "Rozsah zvýšenia je obmedzený na 1-100",

        tipRowHeightLimit: "Výška riadka musí byť medzi 0 a 545",
        tipColumnWidthLimit: "Šírka stĺpca musí byť medzi 0 a 2038",
        pageInfoFull: "Celkom ${total}，${totalPage} stránka，Zobrazené všetky údaje"
    },
    currencyDetail:{
        RMB:'RMB',
        USdollar:'US dollar',
    ...
    fontarray: ["Tahoma","Arial","Times New Roman","Verdana"],
    fontjson: {"tahoma":0,"arial":1,"times new roman":2,"verdana":3},
    border:{
        borderTop:'borderTop',
    ...
    filter:{
        filter: "Vytvořit filtr",

        sortByAsc: "Seřadit A-Z",
        sortByDesc: "Seřadit Z-A",
        
        filterByColor: "Filtrovat podle barvy",
        filterByCondition: "Filtrovat podle podmínky",
        filterByValues: "Filtrovat podle hodnot",
        
        filiterInputNone: "Žádné",
        
        filiterInputTip: "Zadejte hodnotu filtru",
        filiterRangeStart: "",
        filiterRangeStartTip: "Hodnota pro vzorec",
        filiterRangeEnd: "a",
        filiterRangeEndTip: "Hodnota pro vzorec",
        
        filterValueByAllBtn: "Vybrat všechny",
        filterValueByClearBtn: "Vymazat",
        filterValueByInverseBtn: "Invertovat",
        filterValueByTip: "Filtrovat podle hodnot",
        
        filterConform: "Potvrdit",
        filterCancel: "Zrušit",
        clearFilter: "Vymazat filtr",
        
        conditionNone: "Žádné",
        
        conditionCellIsNull: "Je prázdný",
        conditionCellNotNull: "Není prázdný",
        conditionCellTextContain: "Text obsahuje",
        conditionCellTextNotContain: "Text neobsahuje",
        conditionCellTextStart: "Text začíná na",
        conditionCellTextEnd: "Text končí na",
        conditionCellTextEqual: "Text je přesně",
        conditionCellDateEqual: "Datum je",
        conditionCellDateBefore: "Datum je před",
        conditionCellDateAfter: "Datum je po",
        conditionCellGreater: "Větší než",
        conditionCellGreaterEqual: "Větší nebo rovný",
        conditionCellLess: "Menší než",
        conditionCellLessEqual: "Menší nebo rovný",
        conditionCellEqual: "Je rovný",
        conditionCellNotEqual: "Není rovný",
        conditionCellBetween: "Je mezi",
        conditionCellNotBetween: "Není mezi",
        
        filiterMoreDataTip: "Velké množství dat! Prosím čekejte",
        filiterMonthText: "Měsíc",
        filiterYearText: "Rok",
        filiterByColorTip: "Filtrovat podle barvy buňky",
        filiterByTextColorTip: "Filtrovat podle barvy písma",
        filterContainerOneColorTip: "Tento sloupec obsahuje pouze jednu barvu",
        filterDateFormatTip: "Formát data",
        
        valueBlank: "(Prázdné)",
        mergeError: "Ve výběru filtru jsou sloučené buňky, tuto operaci nelze provést!"
    },
    rightclick: {
        copy: "Kopírovat",
        copyAs: "Kopírovat jako",
        paste: "Vložit",
        insert: "Vložit",
        delete: "Vymazat",
        deleteCell: "Vymazat buňku",
        deleteSelected: "Vymazat vybrané",
        hide: "Skrýt",
        hideSelected: "Skrýt vybrané",
        showHide: "Zobrazit skryté",
        to: "K",
        left: "Vlevo",
        right: "Vpravo",
        top: "Nahoru",
        ...
        matrix: "Matice",
        sortSelection: "Třídit",
        filterSelection: "Filtrovat",
        chartGeneration: "Vytvořit graf",
        firstLineTitle: "První řádek názvu",
        untitled: "Bez názvu",
        array1: "Jednorozměrné pole",
        array2: "Dvourozměrné pole",
        array3: "Více rozměrné pole",
        diagonal: "Diagonála",
        antiDiagonal: "Antidiagonála",
        diagonalOffset: "Diagonální posun",
        offset: "Posun",
        boolean: "Boolean",
        flip: "Otočit",
        upAndDown: "Nahoru a dolů",
        leftAndRight: "Vlevo a vpravo",
        clockwise: "Ve směru hodinových ručiček",
        counterclockwise: "Proti směru hodinových ručiček",
        transpose: "Transponovat",
        matrixCalculation: "Matematický výpočet",
        plus: "Plus",
        minus: "Mínus",
        multiply: "Násobit",
        divided: "Dělit",
        ...
        root: "Kořen",
        log: "Logaritmus",
        delete0: "Vymazat hodnoty 0 na obou koncích",
        removeDuplicate: "Odstranit duplicitní hodnoty",
        byRow: "Podle řádku",
        byCol: "Podle sloupce",
        generateNewMatrix: "Generovat novou matici"
    },
    comment:{
        "insert":"Insert",
        "edit":"Edit",
    ...
    findAndReplace:{
        ...
        columnSpan: "Rozsah sloupců",
        locationExample: "Příklad lokace",
        lessTwoRowTip: "Vyberte prosím alespoň dva řádky",
        lessTwoColumnTip: "Vyberte prosím alespoň dva sloupce",
    
        findTextbox: "Najít obsah",
        replaceTextbox: "Nahradit obsah",
    
        regexTextbox: "Regulární výraz",
        wholeTextbox: "Celé slovo",
        distinguishTextbox: "Rozlišovat velikost písmen",
    
        allReplaceBtn: "Nahradit vše",
        replaceBtn: "Nahradit",
        allFindBtn: "Najít vše",
        findBtn: "Najít další",
    
        noFindTip: "Obsah nebyl nalezen",
        modeTip: "Tato operace není k dispozici v tomto režimu",
    
        searchTargetSheet: "List",
        searchTargetCell: "Buňka",
        searchTargetValue: "Hodnota",
    
        searchInputTip: "Prosím, zadejte hledaný obsah",
    
        noReplceTip: "Není co nahradit",
        noMatchTip: "Nenašly se žádné shody",
    
        successTip: "Nalezeno ${xlength} položek",
    
        locationConstant: "Konstanta",
        locationFormula: "Vzorec",
        locationDate: "Datum",
        locationDigital: "Číslo",
        locationString: "Řetězec",
        locationBool: "Logická hodnota",
        locationError: "Chyba",
        locationNull: "Nulová hodnota",
        locationCondition: "Podmíněné formátování",
        locationRowSpan: "Rozsah řádků",
        locationColumnSpan: "Rozsah sloupců",
    
        locationTiplessTwoRow: "Vyberte prosím alespoň dva řádky",
        locationTiplessTwoColumn: "Vyberte prosím alespoň dva sloupce",
        locationTipNotFindCell: "Buňka nebyla nalezena"
    },
    sheetconfig: {
        delete: "Vymazat",
        copy: "Kopírovat",
        ...
        resetColor: "Resetovat barvu",
        cancelText: "Zrušit",
        chooseText: "Potvrdit barvu",
    
        tipNameRepeat: "Název karty stránky se nesmí opakovat! Prosím opravte",
        noMoreSheet: "Sešit obsahuje alespoň jeden viditelný list. Pokud chcete vymazat vybraný list, vložte nový list nebo zobrazte skrytý list.",
        confirmDelete: "Jste si jisti, že chcete vymazat",
        redoDelete: "Může být vráceno zpět pomocí Ctrl+Z",
        noHide: "Není možné skrýt, alespoň jedna karta listu musí zůstat",
        chartEditNoOpt: "Tato operace není povolena v režimu úpravy grafu!",
        sheetNameSpecCharError: "Název nesmí obsahovat: [ ] : \\ ? * / ' \"",
        sheetNamecannotIsEmptyError: "Název listu nemůže být prázdný"
    },
    conditionformat: {
    ...
    formula:{
        ...
        max: "Maximum",
        min: "Minimum",
        ifGenerate: "Generátor IF vzorce",
        find: "Zjistit více",
    
        tipNotBelongToIf: "Tato funkce buňky nepatří do IF vzorce!",
        tipSelectCell: "Prosím, vyberte buňku pro vložení funkce",
    
        ifGenCompareValueTitle: "Porovnávací hodnota",
        ifGenSelectCellTitle: "Klikněte pro výběr buňky",
        ifGenRangeTitle: "Rozsah",
        ifGenRangeTo: "do",
        ifGenRangeEvaluate: "Hodnocení rozsahu",
        ifGenSelectRangeTitle: "Klikněte pro výběr rozsahu",
        ifGenCutWay: "Způsob rozdělení",
        ifGenCutSame: "Rozdělení podle stejné hodnoty",
        ifGenCutNpiece: "Rozdělení podle N",
        ifGenCutCustom: "Vlastní",
        ifGenCutConfirm: "Potvrdit",
    
        ifGenTipSelectCell: "Vyberte buňky",
        ifGenTipSelectCellPlace: "Prosím, vyberte buňky",
    
        ifGenTipSelectRange: "Vyberte rozsah",
        ifGenTipSelectRangePlace: "Prosím, vyberte rozsah",
    
        ifGenTipNotNullValue: "Porovnávací hodnota nesmí být prázdná!",
        ifGenTipLableTitile: "Označení",
        ifGenTipRangeNotforNull: "Rozsah nesmí být prázdný!",
        ifGenTipCutValueNotforNull: "Hodnota rozdělení nesmí být prázdná!",
        ifGenTipNotGenCondition: "Pro generování nejsou k dispozici žádné podmínky!"
    },
    formulaMore:{
        valueTitle:"Value",
    ...
    protection:{
        protectiontTitle: "Ochrana",
        enterPassword: "Zadejte heslo (volitelné)",
        enterHintTitle: "Výzva při úpravě je zakázaná (volitelné)",
        enterHint: "Buňka nebo graf, který se pokoušíte změnit, je v chráněném listu. Pokud jej chcete změnit, odemkněte list. Možná budete muset zadat heslo",
        swichProtectionTip: "Chránit list a obsah zamčených buněk",
        authorityTitle: "Povolit uživatelům tohoto listu:",
        selectLockedCells: "Vybrat zamčené buňky",
        selectunLockedCells: "Vybrat odemčené buňky",
        formatCells: "Formátovat buňky",
        formatColumns: "Formátovat sloupce",
        formatRows: "Formátovat řádky",
        insertColumns: "Vkládat sloupce",
        insertRows: "Vkládat řádky",
        insertHyperlinks: "Vkládat hypertextové odkazy",
        deleteColumns: "Mazat sloupce",
        deleteRows: "Mazat řádky",
        sort: "Třídit",
        filter: "Filtrovat",
        usePivotTablereports: "Používat kontingenční tabulky",
        editObjects: "Upravovat objekty",
        editScenarios: "Upravovat scénáře",
    
        allowRangeTitle: "Povolit uživatelům rozsahu:",
        allowRangeAdd: "Nový...",
    
        allowRangeAddTitle: "Název",
        allowRangeAddSqrf: "Reference",
        selectCellRange: "Klikněte pro výběr rozsahu buněk",
        selectCellRangeHolder: "Rozsah buněk",
        allowRangeAddTitlePassword: "Heslo",
        allowRangeAddTitleHint: "Výzva",
        allowRangeAddTitleHintTitle: "Výzva při nastavení hesla (volitelné)",
        allowRangeAddtitleDefault: "Zadejte název rozsahu",
    
        rangeItemDblclick: "Dvojklik pro úpravu",
        rangeItemHasPassword: "Má heslo",
    
        rangeItemErrorTitleNull: "Název je prázdný",
        rangeItemErrorRangeNull: "Reference jsou prázdné",
        rangeItemErrorRange: "Chybná reference",
    
        validationTitle: "Ověření hesla",
        validationTips: "Pro odemknutí ochrany listu je třeba zadat heslo",
        validationInputHint: "Zadejte heslo",
    
        checkPasswordNullalert: "Heslo je povinné!",
        checkPasswordWrongalert: "Nesprávné heslo, zkuste to znovu!",
    
        checkPasswordSucceedalert: "Úspěšně odemknuto!",
        defaultRangeHintText: "Buňka je chráněná heslem.",
        defaultSheetHintText: "Buňka nebo graf je v chráněném listu. Pokud chcete provést změny, odemkněte list. Možná budete muset zadat heslo"
    },
    cellFormat:{
